package net.alminoris.missingtrees.datagen.loot;
...
{
    private static final LootItemCondition.Builder HAS_NO_SHEARS_OR_SILK_TOUCH = MatchTool.toolMatches(ItemPredicate.Builder.item()
            .of(Items.SHEARS)).or(MatchTool.toolMatches(ItemPredicate.Builder.item()
    ...
    private LootTable.Builder leavesOnlyItemDrop(Block leaves, Item item, float chance)
    {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(this.applyExplosionDecay(leaves,
