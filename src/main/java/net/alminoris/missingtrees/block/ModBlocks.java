...
import net.alminoris.missingtrees.block.custom.ModHangingSignBlock;
import net.alminoris.missingtrees.block.custom.ModStandingSignBlock;
import net.alminoris.missingtrees.block.custom.ModWallHangingSignBlock;
import net.alminoris.missingtrees.block.custom.ModWallSignBlock;
...
{
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MissingTrees.MOD_ID);

    public static final RegistryObject<Block> APPLE_FRUIT_LEAVES = registerBlock("apple_fruit_leaves",
