...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public Item getDropItem()
    {
        ...
        {
            case WALNUT -> {
                return ModBlockSetsHelper.WOODEN_CHEST_BOATS.get("walnut").get();
            }

            case SILVER_MAPLE -> {
                return ModBlockSetsHelper.WOODEN_CHEST_BOATS.get("silver_maple").get();
            }

            case STAGHORN_SUMAC -> {
                return ModBlockSetsHelper.WOODEN_CHEST_BOATS.get("staghorn_sumac").get();
            }

            case SILVERBERRY -> {
                return ModBlockSetsHelper.WOODEN_CHEST_BOATS.get("silverberry").get();
            }
        }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_330790_)
    {
        ...
        p_330790_.define(DATA_ID_TYPE, ModBoatEntity.Type.WALNUT.ordinal());
    }
