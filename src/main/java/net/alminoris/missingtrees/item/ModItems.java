...
import net.alminoris.missingtrees.item.custom.ModBoatItem;
...
{
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MissingTrees.MOD_ID);
